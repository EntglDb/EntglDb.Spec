import{d,l as i,a,b as e,m as r,n as s,p as c,o,_ as v}from"./index-C_0Rsq9s.js";const u={class:"spec-content"},p={class:"tabs"},g={class:"tab-header"},b={key:0,class:"tab-content"},S={key:1,class:"tab-content"},m={key:2,class:"tab-content"},k=d({__name:"GettingStarted",setup(h){const n=i("net");return(q,t)=>(o(),a("div",u,[t[6]||(t[6]=e("h1",null,"Getting Started",-1)),t[7]||(t[7]=e("p",{class:"lead"},"EntglDb is a decentralized, offline-first peer-to-peer database. Choose your platform to get started.",-1)),e("div",p,[e("div",g,[e("button",{class:s({active:n.value==="net"}),onClick:t[0]||(t[0]=l=>n.value="net")},".NET",2),e("button",{class:s({active:n.value==="node"}),onClick:t[1]||(t[1]=l=>n.value="node")},"Node.js",2),e("button",{class:s({active:n.value==="kotlin"}),onClick:t[2]||(t[2]=l=>n.value="kotlin")},"Kotlin (Android)",2)]),n.value==="net"?(o(),a("div",b,[...t[3]||(t[3]=[e("h2",null,"Installation",-1),e("p",null,"EntglDb is available found on NuGet.",-1),e("pre",null,[e("code",{class:"language-bash"},`dotnet add package EntglDb.Core
...
server.start();`)],-1)])])):r("",!0),n.value==="kotlin"?(o(),a("div",m,[...t[5]||(t[5]=[c(`<h2 data-v-d330e9a5>Installation</h2><p data-v-d330e9a5>Add dependencies to your <code data-v-d330e9a5>build.gradle.kts</code>.</p><pre data-v-d330e9a5><code class="language-kotlin" data-v-d330e9a5>    implementation(&quot;com.entgldb:core:0.8.0&quot;)
    implementation(&quot;com.entgldb:network:0.8.0&quot;)
    implementation(&quot;com.entgldb:persistence-sqlite-android:0.8.0&quot;)
}</code></pre><h2 data-v-d330e9a5>Platform Setup</h2><p data-v-d330e9a5>Ensure you have internet and multicast permissions in <code data-v-d330e9a5>AndroidManifest.xml</code>.</p><h2 data-v-d330e9a5>Basic Usage</h2><pre data-v-d330e9a5><code class="language-kotlin" data-v-d330e9a5>val dbPath = context.getDatabasePath(&quot;entgldb.db&quot;).absolutePath
...
node.start()</code></pre>`,7)])])):r("",!0)])]))}}),f=v(k,[["__scopeId","data-v-d330e9a5"]]);export{f as default};
